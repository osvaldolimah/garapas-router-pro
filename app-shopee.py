...
st.markdown("""
    ...
    * {
    ...
    /* FORMAS GEOMÉTRICAS DECORATIVAS (BACKGROUND) */
    .stApp::before {
        content: ''; position: fixed; top: -10%; right: -5%; width: 500px; height: 500px;
        background: rgba(255, 255, 255, 0.03); border-radius: 40% 60% 70% 30% / 40% 50% 60% 50%;
    ...
    /* CARDS E CONTAINERS */
    /* Isso aplica o estilo de card aos containers do Streamlit */
    ...
    .pit-link { text-decoration: none; color: #2563EB; font-weight: bold; }
    </style>
